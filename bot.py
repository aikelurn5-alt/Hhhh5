...
from keyboard import main_menu_keyboard, callback_handler  # Import from keyboard.py
...
BOT_TOKEN = os.getenv("BOT_TOKEN", "8331598990:AAHeGLVvLhp_vFAm5XSWwy_56I4Y8gThA18")
